export const User = ({ id, email, first_name, last_name, avatar, isInvite, onClickAddInvite }) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickAddInvite(id)} className="action" src={`/assets/${isInvite ? 'minus':'plus'}.svg`} alt="Action" />
  </li>
);
